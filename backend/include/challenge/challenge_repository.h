...
public:
    ...
    std::optional<Challenge> findPendingBetweenUsers(const std::string& challenger, 
    ...
    // Delete expired challenges (MongoDB TTL handles this, but manual cleanup available)
    int deleteExpired();
};
